...
// $routes->add('buku',' Buku::index', ['filter' => 'role:staff']);
$routes->add('konfirmasi',' Konfirmasi::index', ['filter' => 'role:staff']);
$routes->add('anggota',' Anggota::index', ['filter' => 'role:staff']);
// $routes->add('peminjaman',' Peminjaman::index', ['filter' => 'role:staff']);
// $routes->add('mybook',' Mybook::index', ['filter' => 'role:user']);
$routes->add('pengembalian',' Pengembalian::index', ['filter' => 'role:staff']);
$routes->add('poin',' Poin::index', ['filter' => 'role:staff']);
$routes->get('pushnotif',' PushNotif::index', ['filter' => 'role:staff']);
...
$routes->get('/mybook',' Mybook::index', ['filter' => 'role:user']);
...
$routes->get('/buku', 'Buku::index', ['filter' => 'role:staff']);
...
$routes->get('/notif', 'Notif::index',['filter' => 'role:user']);
$routes->post('/notif/detail/(:num)', 'Notif::detail/$1',['filter' => 'role:user']);
...
$routes->post('/qrcodeReturnConfirm', 'Pengembalian::qr_code_confirm', ['filter' => 'role:staff']);
