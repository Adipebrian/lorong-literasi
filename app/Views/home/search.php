    ...
    <div class="container-xxl container-search d-flex justify-content-center" id="searchBook">
      <form action="/searchBook" method="post">
        <div class="d-flex input-form justify-content-between">
          <input class="form-control" name="key" type="text" placeholder="Search book...." value="<?= $key ?>" />
    ...
    <?php else : ?>
      ...
      <div class="d-flex container book-not-match align-items-center" style="margin-top: 200px;">
        <div class="row text-center">
          <h2>Oops!!! <br>The book you are looking for can't be found</h2>
          <p>the data you are looking for does not exist, make sure the keyword is correct or try using another keyword</p>
        </div>
      </div>
  </div>
<?php endif; ?>
