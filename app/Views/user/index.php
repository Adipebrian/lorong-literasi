                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle" style="width: 80px; height: 80px;" src="/img/<?= $user->image ?>" alt="User profile picture">
                            </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="active tab-pane" id="settings">
                                    <form class="form-horizontal" action="/user/update/<?= $user->userid ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="fullnameLama" value="<?= $user->fullname ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="input" name="fullname" class="form-control <?= ($validation->hasError('fullname')) ? 'is-invalid' : ''; ?>" id="inputName" placeholder="Fullname" value="<?= (old('fullname')) ? old('fullname') : $user->fullname ?>">
